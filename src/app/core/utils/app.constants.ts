...
export const APP_CONSTANTS = {
  URLS: {
    CV_LINK: 'https://drive.google.com/file/d/1Mn3h-lyylnh18ELnqAV7RH-PHjlsK84W/view?usp=sharing',
  ...
  TECH_TAGS: {
    ...
    BACKEND: ['Golang', 'Node.js', '.NET Core', 'PostgreSQL', 'MySQL', 'Redis', 'Docker'],
...
export const PROJECT_DATA = [
  {
    name: 'audio-analyzer',
    description: 'A Flask API for video and audio analysis using OpenAI Whisper and Hugging Face. Features speech-to-text conversion, content summarization, quality checks, and streaming optimization.',
    url: 'https://github.com/zahidhasann88/audio-analyzer',
    keywords: ['Flask', 'OpenAI Whisper', 'Hugging Face', 'speech-to-text', 'API'],
  },
  {
    name: 'kvstore',
    description: 'A Redis-like key-value store implementation in Go with CLI interface and TCP server support.',
    url: 'https://github.com/zahidhasann88/kvstore',
    keywords: ['Redis-like', 'Go', 'CLI', 'TCP'],
  },
  {
    name: 'syncpipe',
    description: 'A file synchronization tool over TCP using Node.js and TypeScript. SyncPipe provides real-time file synchronization between a server and multiple clients using raw TCP sockets.',
...
export const CONTENT_DATA = {
  ABOUT_ME: {
    PART_1: `My name is Zahid Hasan, also known as Zahid. I'm a 28-year-old Software Engineer from Dhaka, Bangladesh.`,
